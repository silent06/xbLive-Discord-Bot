...
namespace stealthbot
{
    class mysql
    {
        ...
        public static void SetFreemode(int Freemode)
        {
            ...
            using (var db = Setup())
            {
                ...
                {
                    command.CommandText = string.Format("UPDATE `vars` SET freemode=@FREEMODE");
                    command.Parameters.AddWithValue("@FREEMODE", Freemode);
        ...
        public static void SaveUserData(string discord, string discordid, string cpukey)
        {
            try
            {
                using (var db = Setup())
                {
                    ...
                    using (var command = db.CreateCommand())
                    {
                        command.CommandText = string.Format("UPDATE `users` SET console_linked=1, Discord=@DISCORD, Discordid=@DISCORDID WHERE cpu=@CPU");
        ...
        public static void UpdateUser(string User, string cpukey)
        {
            using (var db = Setup())
            {
                Connect(db);
                using (var command = db.CreateCommand())
                {
                    command.CommandText = string.Format("UPDATE `users` SET `Username` = @username2 WHERE `cpu` = @cpukey2");
                    command.Parameters.AddWithValue("@cpukey2", cpukey);
                    command.Parameters.AddWithValue("@username2", User);
                    command.ExecuteNonQuery();
                }
                Disconnect(db);
            }
        ...
        public static void UpdatePrimaryColor(string Color, string Color1, string cpukey)
        {
            ...
            using (var db = Setup())
            {
                ...
                using (var command = db.CreateCommand())
                {
                    command.CommandText = string.Format("UPDATE `users` SET primaryuicolor=@PRIMARYUICOLOR, secondaryuicolor=@SECONDARYUICOLOR WHERE cpu=@CPUKEY");
                    command.Parameters.AddWithValue("@CPUKEY", cpukey);
                    command.Parameters.AddWithValue("@PRIMARYUICOLOR", Color);
                    command.Parameters.AddWithValue("@SECONDARYUICOLOR", Color1);
                    command.ExecuteNonQuery();
                }
                Disconnect(db);
            }
        ...
        public static void UpdateQuickLauncher(string qlaunch, string cpukey)
        {
            ...
            using (var db = Setup())
            {
                ...
                using (var command = db.CreateCommand())
                {
                    command.CommandText = string.Format("UPDATE `users` SET qtitleid=@QTITLEID WHERE cpu=@CPUKEY");
                    command.Parameters.AddWithValue("@CPUKEY", cpukey);
                    command.Parameters.AddWithValue("@QTITLEID", qlaunch);
                    command.ExecuteNonQuery();
                }
                Disconnect(db);
            }
        ...
        public static void UpdateClientNoKVLastRefresh(string consoleKey)
        {
            ...
            using (var db = Setup())
            {
                ...
                using (var command = db.CreateCommand())
                {
                    ...
                    command.Parameters.AddWithValue("@nokvlastrefresh", (int)Tools.GetTimeStamp());
                    command.ExecuteNonQuery();
                }
                ...
                using (var command = db.CreateCommand())
                {
                    ...
                    using (var reader = command.ExecuteReader())
                    {
                        if (reader.Read())
                        {
                            ...
                            data.dwTitle = reader.GetString("title");
            ...
            if (GetClientData(consolekey, ref info))
            {
                if (info.Status != ClientInfoStatus.Banned && info.Status != ClientInfoStatus.Disabled)
                {
                    using (var db = Setup())
                    {
                        ...
                        using (var command = db.CreateCommand())
                        {
                            command.CommandText = string.Format("UPDATE users SET time_end = @time_end, `status` = 0 WHERE `cpu` = @console_key");
                            command.Parameters.AddWithValue("@console_key", consolekey);

                            if (info.iTimeEnd > (int)Tools.GetTimeStamp())
                            {
                                command.Parameters.AddWithValue("@time_end", info.iTimeEnd + seconds);
                            }
                            else
                            {
                                command.Parameters.AddWithValue("@time_end", (int)Tools.GetTimeStamp() + seconds);
                            }
        ...
        public static List<ClientInfo> GetAllClientsWithTime()
        {
            ...
            using (var db = Setup())
            {
                ...
                using (var command = db.CreateCommand())
                {
                    ...
                    command.Parameters.AddWithValue("@cur", (int)Tools.GetTimeStamp());
                    using (var reader = command.ExecuteReader())
                    {
                        if (reader.HasRows)
                        {
            ...
            if (GetClientData(console_key, ref info))
            {
                if (info.iReserveSeconds < 30)
                {
                    if (info.iTimeBeforeReserve != 0)
                    {
                        ...
                        {
                            info.iTimeEnd = (int)Tools.GetTimeStamp() + info.iTimeBeforeReserve;
                            info.iTimeBeforeReserve = 0;
                        }
        ...
        public static void UpdateKVStat(string kvhash, bool banned)
        {
            ...
            using (var db = Setup())
            {
                ...
                using (var command = db.CreateCommand())
                {
                    ...
                    command.Parameters.AddWithValue("@last_connection", banned ? cur.iLastConnection : Tools.GetTimeStamp());
                    command.Parameters.AddWithValue("@banned", banned);
                    command.Parameters.AddWithValue("@banned_time", banned && !cur.bBanned ? (int)Tools.GetTimeStamp() : cur.iBannedTime);
                    command.Parameters.AddWithValue("@kv_hash", kvhash);
                    command.ExecuteNonQuery();
                }
                Disconnect(db);
        ...
        public static void AddRequestToken(string token, string console_key)
        {
            using (var db = Setup())
            {
                ...
                using (var command = db.CreateCommand())
                {
                    ...
                    command.Parameters.AddWithValue("@token", token);
                    command.Parameters.AddWithValue("@console_key", console_key);
                    command.Parameters.AddWithValue("@last", Tools.GetTimeStamp());
                    command.Parameters.AddWithValue("@welcome", Tools.GetTimeStamp());
                    command.ExecuteNonQuery();
                }
                Disconnect(db);
            }
        ...
        public static void UpdateUserInfoWelcomePacket(string consolekey, string kvhash, string ip)
        {
            using (var db = Setup())
            {
                ...
                using (var command = db.CreateCommand())
                {
                    ...
                    command.Parameters.AddWithValue("@console_key", consolekey);
                    command.Parameters.AddWithValue("@last_connection", Tools.GetTimeStamp());
                    command.ExecuteNonQuery();
                }
                Disconnect(db);
            }
            ...
            using (var db = Setup())
            {
                ...
                using (var command = db.CreateCommand())
                {
                    ...
                    else
                    {
                        ...
                        command.Parameters.AddWithValue("@time_end", (int)Tools.GetTimeStamp() + 604800);
                    }
        ...
        public static void AddMetric(string consolekey, eMetricType type, eMetrics index, string additionalInfo)
        {
            using (var db = Setup())
            {
                ...
                using (var command = db.CreateCommand())
                {
                    ...
                    command.Parameters.AddWithValue("@time", Tools.GetTimeStamp());
